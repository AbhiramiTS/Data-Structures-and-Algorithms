...
def stockBuySell(A, n):
    ...
    for i in range(1, n):
        ...
        if A[i] < A[sell_index]:
            if count != 0:
                stocks.append([buy_index, sell_index])
            count = 0
            buy_index = i
        else:
            count += 1
        if i == n - 1 and count != 0:
            print(count, A[i], A[sell_index])
...
N1 = 9
A1 = [100, 180, 260, 310, 40, 535, 695, 80, 90]
print(stockBuySell(A1, N1))  # Output: [[0, 3], [4, 6],[7,8]]

N2 = 5
A2 = [4, 2, 2, 2, 4]
print(stockBuySell(A2, N2))  # Output: [[3, 4]]
